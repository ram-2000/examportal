...
<body>
  ...
  <!--  <div class="l">
    	<div class="card" style="width: 9rem; height:9rem;">
                            <div class="card-body">
                                <img src="C:\Users\nikhi\OneDrive\Desktop\examc@ll\pics\question1.jpg" alt="Paris" width="100" height="100">
                              <h5 class="card-title text-dark"style="font-size: 10px;">QUESTION PAPER</h5>
                              <p class="card-text"></p>
    ...
    <div class="lll">
        <div class="card" style="width: 9rem; height:9rem;"> 
            <div class="card-body"> <img
                    src="C:\Users\nikhi\OneDrive\Desktop\examc@ll\pics\admin.jpg"
                    alt="Paris" width="100" height="100"> <h5
                    class="card-title text-dark" style="font-size: 10px;">SEATING ARRANGEMENT </h5> <p
                    class="card-text"> </p>
